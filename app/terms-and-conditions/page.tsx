...
export default function TermsAndConditions() {
  ...
  <div className="page-wrapper overflow-hidden">
    ...
    <section className="terms-conditions py-5 py-lg-11">
      <div className="container">
        <p className="fs-5 text-dark fw-medium">This Bootstrap Admin Templates Terms of Service <span
            className="fw-bold">(“Agreement”)</span> is entered into by
          and between Bootstrap Admin Templates <span className="fw-bold">(“Bootstrap Admin Templates”)</span> and the
          entity or person placing an order for or
          accessing the Services <span className="fw-bold">(“Customer”)</span>. This Agreement consists of the terms and
          conditions set forth below and
          any Order Form. The <span className="fw-bold">“Effective Date”</span> of this Agreement is the date which is the
        ...
        <p className="fs-5 text-dark fw-medium">Capitalized terms shall have the meanings set forth in Section 1, or in the
          section where they are first used
        </p>
        <h4 className="my-4">1. Definitions</h4>
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">1.1 “Authorized Devices”</span> means those mobile,
          desktop, or other devices with which the Services can be accessed and used.</p>
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">1.2 “Content”</span> means code, content, fonts,
        ...
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">1.3 “Documentation”</span> means the technical
        ...
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">1.4 “Services”</span> Bootstrap Admin Templates
          proprietary
        ...
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">1.5 “Order Form”</span> means a document signed by
          both Parties identifying the Enterprise Services to be made available by Bootstrap Admin Templates pursuant to
          this
          Agreement.</p>
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">1.6 “Packages”or“Components”</span> means add-on
        ...
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">1.7 “User”</span> means an employee, contractor or
          other individual associated with Customer who has been provisioned by Customer with access to the Services.
        </p>
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">1.8 “Services”</span> means Bootstrap Admin Templates
        ...
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">2.1 Services </span> Bootstrap Admin Templates hereby
          grants
        ...
        <p className="fs-5 text-dark fw-medium"><span className="fw-bold">2.2 Provisioning the Services</span>
