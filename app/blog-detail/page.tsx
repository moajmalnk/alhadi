...
export default function BlogDetail() {
  ...
  <div className="page-wrapper overflow-hidden">
    ...
    <section className="banner-section banner-inner-section position-relative overflow-hidden d-flex align-items-end"
      style={{ backgroundImage: 'url(/assets/images/backgrounds/blog-detail-banner.jpg)' }}>
      <div className="container">
        <div className="d-flex flex-column gap-4 pb-5 pb-xl-10 position-relative z-1">
          <div className="row align-items-center">
            <div className="col-xl-4">
              <div className="d-flex align-items-center gap-4" data-aos="fade-up" data-aos-delay="100"
                ...
                <p className="mb-0 text-white fs-5 text-opacity-70">In a <span className="text-primary">world where
          ...
          <div className="d-flex align-items-end gap-3" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
            <h1 className="mb-0 fs-15 text-white lh-1">A campaign that connects</h1>
        ...
        <div className="d-flex flex-column gap-7 gap-xl-11">
          <div className="row gap-4 gap-lg-0">
            <div className="col-lg-4">
              <h2 className="fs-13 mb-0" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">Scroll to read
              </h2>
            </div>
          ...
          <div className="blog-detail-img" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
            <img src="/assets/images/backgrounds/blog-detail-img.jpg" alt="blog-detail" className="img-fluid" />
          </div>
