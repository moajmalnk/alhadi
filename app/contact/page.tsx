export default function Contact() {
  ...
  <div className="page-wrapper overflow-hidden">
    ...
    <section className="banner-section banner-inner-section position-relative overflow-hidden d-flex align-items-end"
      style={{ backgroundImage: 'url(/assets/images/backgrounds/contact-us2.jpg)' }}>
          ...
          <div className="row align-items-center">
            <div className="col-xl-4">
              <div className="d-flex align-items-center gap-4" data-aos="fade-up" data-aos-delay="100"
                ...
                <p className="mb-0 text-white fs-5 text-opacity-70">Contact us today for professional <span className="text-primary">business setup and PRO services</span> in the UAE.</p>
              </div>
            </div>
          </div>
        ...
        <div className="d-flex flex-column gap-5 gap-xl-10">
          ...
          <div className="row justify-content-between gap-7 gap-xl-0">
            <div className="col-xl-3">
              <p className="mb-0 fs-5" data-aos="fade-right" data-aos-delay="100" data-aos-duration="1000">Start your UAE business registration with a free expert consultation from Al Hadi Business Services in Dubai. Tell us about your business needs—we’re here to help.</p>
            </div>
              ...
              <form className="d-flex flex-column gap-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <input type="email" className="form-control border-bottom border-dark" id="email"
                      placeholder="Email" />
                  </div>
                  <div className="col-md-6">
                    <input type="tel" className="form-control border-bottom border-dark" id="phone"
            ...
            <div className="col-xl-8 col-xxl-7">
              ...
              >
                ...
                <p className="fs-5 mb-0 text-opacity-70">
                  Prefer to call or email? Reach Al Hadi Business Services directly — we&apos;re ready to help with
                  business setup, PRO services, visas, and more.
                </p>
              </div>
            </div>
          </div>
              ...
              >
                <div className="card-body d-flex gap-4 p-4 p-xl-5">
                  <span className="round-52 flex-shrink-0 rounded-circle bg-dark hstack justify-content-center">
                    <iconify-icon icon="lucide:map-pin" className="fs-7 text-white"></iconify-icon>
                  </span>
                  <div className="d-flex flex-column gap-2">
                    ...
                    >
                      Get directions
                      <iconify-icon icon="lucide:arrow-up-right" className="fs-6"></iconify-icon>
                    </a>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="card-body d-flex gap-4 p-4 p-xl-5">
                  ...
                  <div className="d-flex flex-column gap-2">
                    ...
                    <a href="tel:+97144312227" className="link-hover text-dark text-decoration-none">
                      +971-4 431 2227
                    </a>
                    <a href="tel:+971589484494" className="link-hover text-dark text-decoration-none">
                      +971 58 948 4494
                    </a>
                    <a href="tel:+971524642020" className="link-hover text-dark text-decoration-none">
                      +971 52 464 2020
                    </a>
                    <a href="tel:+971523709846" className="link-hover text-dark text-decoration-none">
                      +971 52 370 9846
                    </a>
                    <a href="tel:+971581392020" className="link-hover text-dark text-decoration-none">
                      +971 58 139 2020
                    </a>
                  </div>
                </div>
