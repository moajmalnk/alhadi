        ...
        <div className="sign-in card mx-auto shadow-lg">
          <div className="card-body py-8 px-lg-5">
            ...
            <form className="d-flex flex-column gap-3">
              <div>
                <input type="text" id="disabledTextInput" className="form-control border-bottom" placeholder="Name" />
              </div>
              <div>
              ...
              <a href="/sign-in" className="btn btn-dark w-100 justify-content-center py-2 fw-medium my-7 fs-4 lh-lg">
                Sign Up
              </a>
            </form>
            <p className="text-center mb-1 d-block fw-medium">By creating an account, you agree with our <a
                className="text-dark" href="/privacy-policy">Privacy</a> and <a className="text-dark" href="/privacy-policy">Policy</a>.</p>
            <p className="mb-0 fw-medium text-center">Already have an account? <a className="text-dark" href="/sign-in">Sign
                In</a>
            </p>
          </div>
        </div>
